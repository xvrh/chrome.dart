...
Future<void> runTests(String source,
  ...
  var server = Server(
    onInfo: () => ServerInfo(
        puppeteerUrl: browser.wsEndpoint, platform: Platform.operatingSystem),
    onLog: (log) => print(log.log),
  ...
  for (var dartFile in sourceDir
    ...
    if (!dartFile.path.endsWith('_test.dart')) {
      ...
      print("Compiled ${dartFile.path} to ${outputPath}");
    }
  }
