...
extension JSSystemDisplayExtension on JSSystemDisplay {
  ...
  ///  |callback|: The callback to invoke with the results.
  external void getDisplayLayout();
  ...
  external void enableUnifiedDesktop();
  ...
  ///  |id|: The display's unique identifier.
  external void overscanCalibrationStart();
  ...
  ///  |id|: The display's unique identifier.
  external void startCustomTouchCalibration();
  ...
  ///  display.
  ///  |id|: The display's unique identifier.
  external void clearTouchCalibration();
