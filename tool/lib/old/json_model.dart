...
class JsonFunction extends JsonObject {
  ...
  final JsonReturnType? returnsAsync;
  ...
  JsonFunction(Map<String, dynamic> json)
      : parameters = JsonParamType.parse(json['parameters'] as List?),
        returns = json.containsKey('returns')
            ? JsonReturnType(json['returns']! as Map<String, dynamic>)
            : null,
        returnsAsync = json.containsKey('returns_async')
            ? JsonReturnType(json['returns_async']! as Map<String, dynamic>)
            : null,
        super(json);
...
class JsonConverter {
  ...
  static ChromeLibrary convert(JsonNamespace namespace) {
    var library = ChromeLibrary(namespace.namespace);
    var converter = JsonConverter._(library);
